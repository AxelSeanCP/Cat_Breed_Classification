...
Original file is located at
    https://colab.research.google.com/drive/1UneG4j0n55sRhGMxWHOzQ2PUGmtfm_UY
...
model.add(Conv2D(64, (3,3), activation="relu", input_shape=(224,224,3), kernel_regularizer=l2(0.0001)))
