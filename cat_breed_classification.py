...
Original file is located at
    https://colab.research.google.com/drive/1hRkB3gqT1Gsz6kdN7cfVITozg0FvgLHy
...
model.add(Conv2D(128, (3,3), activation="relu", input_shape=(224,224,3), kernel_regularizer=l2(0.0001)))
...
berhenti_bang = SantaiDuluGakSih(sabar_acc=6, sabar_loss=10)
modelku = model.fit(
    train_generator,
    epochs=30,
    ...
    callbacks=[berhenti_bang, reduce_lr, tensorboard_callback, learningrateLogger()],
    verbose=2
)
