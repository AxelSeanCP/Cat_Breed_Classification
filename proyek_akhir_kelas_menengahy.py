...
Original file is located at
    https://colab.research.google.com/drive/1FLnSFsk5XDyhBT6I0PM_eXSkXeKeqiA9
...
model.add(Dropout(0.3))
model.add(Flatten())
model.add(Dense(496, activation="relu", kernel_regularizer=tf.keras.regularizers.l2(0.001)))
