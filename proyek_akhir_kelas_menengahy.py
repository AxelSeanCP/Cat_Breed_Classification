# -*- coding: utf-8 -*-
"""proyek_akhir_kelas_menengahy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RV-Nqrvqe6lpHWPU1ehUrKk0qgXbSLJb
...
model.add(Dropout(0.3))
model.add(Flatten())
model.add(Dense(354, activation="relu", kernel_regularizer=tf.keras.regularizers.l2(0.0001)))
...
int_lr = 1e-4
lr_schedule = tf.keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=int_lr, decay_steps=800, decay_rate=0.7)
model.compile(
